...
print(average(mu))
#savetxt('N_C_1.csv', N/C, delimiter=",", fmt='%.8e')
...
##summarize to arrays, C and N allocation
...
savetxt('SC6_6h_H1_0207.csv', SC, delimiter=",",fmt="%s")
savetxt('SN6_6h_H1_0207.csv', SN, delimiter=",",fmt="%s")
savetxt('mu_6h_H1_0207.csv', mu, delimiter=",",fmt='%.8e')
savetxt('Nfix_6h_H1.csv', Nfix, delimiter=",", fmt="%s")
